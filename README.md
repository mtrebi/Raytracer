...
&nbsp;[Build instructions](https://github.com/mtrebi/Raytracer#build-instructions)  <br/> 
...
![Dependency diagram](https://github.com/mtrebi/Raytracer/blob/master/docs/images/class_diagram.png "Simple dependency diagram")
...
This is the result:
![Flat shading](https://github.com/mtrebi/Raytracer/blob/master/docs/images/flat-shading.bmp "Flat shading example")
...
![Phong - ambient and diffuse components](https://github.com/mtrebi/Raytracer/blob/master/docs/images/phong-diffuse.bmp "Ambient and diffuse components of Phong shading")

Ambient and specular components:

![Phong - ambient and specular components](https://github.com/mtrebi/Raytracer/blob/master/docs/images/phong-specular.bmp "Ambient and specular components of Phong shading")

Phong complete:

![Phong with all components](https://github.com/mtrebi/Raytracer/blob/master/docs/images/phong-complete.bmp "Phong shading with all components")
...
![Color transfer from a red light](https://github.com/mtrebi/Raytracer/blob/master/docs/images/color_transfer.PNG "Color transfer from a red light")
...
![Phong with an extra parameter](https://github.com/mtrebi/Raytracer/blob/master/docs/images/phong-new-parameter.bmp "Phong with an extra parameter")
...
![Light attenuatted by distance](https://github.com/mtrebi/Raytracer/blob/master/docs/images/light-attenuatted.bmp "Light attenuatted by distance")
...
![Hard shadows with multiple light sources](https://github.com/mtrebi/Raytracer/blob/master/docs/images/hard-shadows.bmp "Hard shadows with multiple light sources")
...
![Hard and soft shadows with multiple light sources](https://github.com/mtrebi/Raytracer/blob/master/docs/images/hard-soft-shadows.bmp "Hard and soft shadows with multiple light sources")
...
![Mirror reflection](https://github.com/mtrebi/Raytracer/blob/master/docs/images/reflected-mirror.bmp "Mirror reflection")
...
![Water refraction example](https://github.com/mtrebi/Raytracer/blob/master/docs/images/final-alising.bmp "Water refraction example")
...
![Image with regular samplingh with 256 samples](https://github.com/mtrebi/Raytracer/blob/master/docs/images/final-256-sampling.bmp "Image with regular samplingh with 256 samples]")
